...
namespace DeliverEat.ControlesPersonalizados
{
    public class RJDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Color.FromArgb(245, 245, 245);//Color.MediumSlateBlue;
        private Color textColor = Color.FromArgb(89, 89, 89);
        private Color borderColor = Color.FromArgb(97, 97, 97);
